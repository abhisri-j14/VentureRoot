        ...
        <div className="relative z-10 p-8 pt-10 md:pt-12 h-full hidden md:block">
          ...
          <div className="absolute inset-0 flex flex-col justify-center p-8 pointer-events-none z-10">
            <div className="max-w-[380px]">
              <h2 className="text-[29px] font-sans font-normal italic text-[#FFFBE7] leading-[1.15] drop-shadow-sm">
            ...
            >
              ...
              <motion.div variants={itemVariants} className="flex items-center justify-between">
                <label className="flex items-center gap-2.5 cursor-pointer group">
                  ...
                  />
                  <span className="text-sm font-normal text-[#200813]/70 group-hover:text-[#200813] transition-colors">Remember me</span>
                </label>
                <Link href="/login" className="text-sm font-medium text-[#1E6702] hover:text-[#1E6702]/80 transition-colors">
                  Forgot password?
                </Link>
              </motion.div>
              ...
              <motion.div variants={itemVariants} className="flex items-center gap-4 my-2">
                ...
                <span className="text-xs font-medium text-[#200813]/40 uppercase tracking-wider">or</span>
                <div className="flex-1 h-px bg-[#200813]/10" />
              </motion.div>

              <motion.div variants={itemVariants} className="flex flex-col gap-3">
                <button type="button" className="w-full py-3 rounded-xl bg-white border border-[#200813]/10 text-[#200813] font-medium hover:bg-[#200813]/5 transition-colors shadow-sm flex items-center justify-center gap-2">
