          ...
          <React.Fragment key={comp.id}>
            <div className="flex-1 bg-slate-50 p-5 rounded-2xl shadow-sm border border-slate-100 z-10 relative">
              <div className="flex flex-col mb-4">
                ...
                <span className={`text-xs font-bold uppercase tracking-widest px-2.5 py-1 rounded-full mt-2 self-start border ${
                  comp.type === "Direct"
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <span className="block text-xs font-bold uppercase tracking-widest text-red-600 mb-2">
            ...
            {index < (data.competitors || []).length - 1 && (
              <div className="md:absolute md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 flex justify-center items-center py-2 md:py-0 z-20">
                <div className="w-9 h-9 rounded-full bg-gray-800 text-white flex items-center justify-center font-black text-xs shadow ring-4 ring-white">
                  VS
                </div>
              </div>
            )}
