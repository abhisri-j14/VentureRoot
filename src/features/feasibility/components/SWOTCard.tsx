      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 border-b border-slate-200">
          ...
          <div className="md:col-span-5 p-2 text-center border-b md:border-b-0 md:border-r border-slate-200">
            <span className="text-xs font-bold text-teal-600 uppercase tracking-widest">Helpful</span>
          </div>
          <div className="md:col-span-5 p-2 text-center">
            <span className="text-xs font-bold text-red-500 uppercase tracking-widest">Harmful</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 border-b border-slate-200">
          <div className="hidden md:flex md:col-span-1 items-center justify-center border-r border-slate-200 bg-slate-50">
            <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest -rotate-90">Internal</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12">
          <div className="hidden md:flex md:col-span-1 items-center justify-center border-r border-slate-200 bg-slate-50">
            <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest -rotate-90">External</span>
          </div>
