      ...
      <div className="flex flex-col gap-6 relative z-10">
        {sortedActions.map((action, index) => (
          <div key={action.id} className="flex flex-col sm:flex-row gap-4 sm:gap-6 w-full group">
            ...
            <div className="hidden sm:flex flex-col items-center shrink-0 w-8 md:w-12 pt-5">
              <div className="w-4 h-4 rounded-full border-4 border-white bg-primary shadow-sm z-10 group-hover:scale-125 transition-transform" />
            </div>
