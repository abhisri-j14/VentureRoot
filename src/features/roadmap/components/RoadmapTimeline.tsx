...
export const RoadmapTimeline = ({ actions }: RoadmapTimelineProps) => {
  ...
  return (
    <div className="relative w-full max-w-5xl mx-auto py-4 sm:py-8">
      ...
      <div className="flex flex-col gap-4 sm:gap-6 relative z-10 w-full min-w-0">
        {sortedActions.map((action, index) => (
          <div key={action.id} className="flex flex-col sm:flex-row gap-3 sm:gap-6 w-full min-w-0 group">
