...
export const DashboardBackground = () => {
  return (
    <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none flex items-center justify-center">
      ...
      <FloatingElement delay={0} duration={8} className="top-[10%] left-[15%] w-32 h-32 opacity-30">
      ...
      <FloatingElement delay={2} duration={10} className="bottom-[15%] right-[10%] w-48 h-48 opacity-20">
      ...
      <FloatingElement delay={1} duration={9} className="bottom-[5%] left-[45%] w-20 h-20 opacity-40">
      ...
      <FloatingElement delay={3} duration={11} className="top-[40%] right-[20%] w-24 h-24 opacity-30">
      ...
      <FloatingElement delay={4} duration={7} className="top-[25%] right-[40%] w-12 h-12 opacity-30">
      ...
      <FloatingElement delay={1.5} duration={8.5} className="bottom-[35%] left-[25%] w-16 h-16 opacity-30">
        <div className="w-full h-full rounded-full bg-[radial-gradient(circle_at_30%_30%,_#ffffff,_#e6f0d1_60%,_#c2d1a3)] shadow-sm flex items-center justify-center">
